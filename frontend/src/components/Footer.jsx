            ...
            <div className="container-x px-6 py-14 grid md:grid-cols-3 gap-10">
                <div>
                    <div className="flex items-center gap-3">
                        <span className="w-10 h-10 rounded-full bg-[#0E5E48] grid place-items-center text-[#F6F1E8] font-display text-lg">
                            T
                        </span>
                        <div>
                    ...
                    <div className="flex gap-3 mt-6">
                        ...
                        <Social href="https://chat.whatsapp.com/KTs87c2XR2I0JwYpU8dDEE" icon={MessageCircle} label="WhatsApp" />
                    </div>
                </div>
