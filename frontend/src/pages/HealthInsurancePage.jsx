    ...
    <div className="relative min-h-screen bg-[#FBF7EE]">
      ...
      <main className="pt-32 pb-24 px-6">
        <div className="max-w-2xl mx-auto text-center">
          <h1 className="font-serif text-3xl sm:text-4xl text-[#0E1B2C] mb-4">Health Insurance Advisory</h1>
          <p className="text-[#2A364B]/80 leading-relaxed mb-2">
            Our dedicated health insurance policy comparison tool is coming soon. In the meantime, talk to us
            directly for personalised mediclaim guidance — the right health cover, at the right premium,
