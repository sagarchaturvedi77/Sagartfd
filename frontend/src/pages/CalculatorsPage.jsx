...
const DEFAULT_SEO = {
  ...
  keywords: "SIP calculator, SIP calculator online, free SIP calculator, EMI calculator, loan calculator, home loan EMI calculator, income tax calculator, income tax calculator online, lumpsum calculator, lump sum calculator, SWP calculator, systematic withdrawal plan calculator, GST calculator online, mutual fund calculator, mutual fund SIP calculator, goal based investment calculator, daily SIP calculator, step up SIP calculator, retirement calculator, inflation calculator, best SIP calculator India, HDFC SIP calculator, SBI SIP calculator, ICICI SIP calculator, Axis SIP calculator, Nippon India SIP calculator, Kotak SIP calculator, UTI SIP calculator, Mirae Asset SIP calculator",
};
