    ...
    <PortalLayout>
      ...
      {activeWidgets.includes("stats") && (
        <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 mb-8">
          <StatCard label="Total Employees" value={employees.length} color="navy" />
      ...
      {activeWidgets.includes("team") && (
        <div className="bg-white dark:bg-[#101D2E] rounded-2xl border border-[#E2D8C2] dark:border-white/10 shadow-sm overflow-hidden">
          <div className="p-6 border-b border-[#E2D8C2] dark:border-white/10 flex items-center justify-between">
            <div>
              <h2 className="text-lg font-serif text-[#0E1B2C] dark:text-[#F1EDE3]">Team Members</h2>
              <p className="text-xs text-[#2A364B]/50 dark:text-[#C7CEDA]/50 mt-0.5">{employees.length} employees registered</p>
            </div>
            <Button
          ...
          {loading ? (
            ...
            <DataTable
              ...
              emptySubtitle='Click "Add Employee" to get started.'
            />
          )}
        </div>
      )}
