...
export default function AdminLeads() {
  ...
  useEffect(() => { load(); loadWebLeads(); loadPipeline(); }, [load, loadWebLeads, loadPipeline]);
    ...
    <PortalLayout>
      <div className="space-y-6">
        ...
        <div className="flex gap-2 border-b border-[#E2D8C2]">
          {[["leads", "All Leads"], ["website", `Website Leads (${webLeads.length})`], ["pipeline", "Pipeline Config"]].map(([key, label]) => (
